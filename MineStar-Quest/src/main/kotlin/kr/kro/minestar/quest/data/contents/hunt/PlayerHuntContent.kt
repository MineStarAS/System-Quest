...
class PlayerHuntContent(override val player: Player, override val entityName: String, override val amount: Int, var huntedAmount: Int) : DefaultHuntContent(entityName, amount), PlayerType {
